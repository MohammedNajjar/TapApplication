...
import com.example.tabapplication.databinding.ActivityUregisterBinding;
...
public class URegisterActivity extends AppCompatActivity {
    ...
    private ActivityUregisterBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityUregisterBinding.inflate(getLayoutInflater());
        ...
        binding.registerAdminEtAddress.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View view, boolean b) {
                Toast.makeText(URegisterActivity.this, "Click on the location icon to locate the place on the map ", Toast.LENGTH_LONG).show();
            }
        });
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(URegisterActivity.this, "Registered " + user.getEmail(), Toast.LENGTH_LONG).show();
                                String cat = ((Categories)binding.spinner.getSelectedItem()).getTitle();
                                UseRestaurant entity = new UseRestaurant(1, name, email, password, address, phone, image, lat, log,cat);
                                db.collection(Entitys_COLLECTION).add(entity).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                                    @Override
                                    public void onSuccess(DocumentReference documentReference) {
                                        binding.mainProgressBar.setVisibility(View.GONE);
                                        Toast.makeText(URegisterActivity.this, "Register Successfully", Toast.LENGTH_LONG).show();
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(URegisterActivity.this, "Register Failure", Toast.LENGTH_LONG).show();
                                    }
                                });
                                binding.mainProgressBar.setVisibility(View.GONE);
                                binding.registerAdminBtnSave.setEnabled(true);
                                ...
                                Toast.makeText(URegisterActivity.this, "Authentication failed.", Toast.LENGTH_LONG).show();
                                binding.mainProgressBar.setVisibility(View.GONE);
                                binding.registerAdminBtnSave.setEnabled(true);
                            }
                        }
